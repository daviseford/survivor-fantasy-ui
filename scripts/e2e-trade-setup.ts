...
const COMPETITION_ID = "competition_e2e_trades";
const EMAIL_A = "trader-a@survivor-fantasy.test";
const EMAIL_B = "trader-b@survivor-fantasy.test";
...
async function deleteTradesSubcollection(): Promise<void> {
...
async function setup(): Promise<void> {
  ...
  await deleteTradesSubcollection();
...
async function teardown(): Promise<void> {
  ...
  await deleteTradesSubcollection();
  await db.collection("competitions").doc(COMPETITION_ID).delete();
  console.log(`  Deleted ${COMPETITION_ID}`);
  await deleteUserIfExists(EMAIL_A);
  await deleteUserIfExists(EMAIL_B);
