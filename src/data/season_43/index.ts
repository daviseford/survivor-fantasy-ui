...
export const SEASON_43_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 28 | Hometown: Philadelphia, Pennsylvania | Occupation: Teacher",
    age: 28,
    profession: "Teacher",
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Marina Del Ray, California | Occupation: Cyber Security Sales",
    age: 29,
    profession: "Cyber Security Sales",
  ...
  buildPlayer({
    ...
    description:
      "Age: 43 | Hometown: Weatherford, Texas | Occupation: Pharmacist",
    age: 43,
  ...
  buildPlayer({
    ...
    description:
      "Age: 42 | Hometown: Downington, Pennsylvania | Occupation: Pediatric Nurse",
    age: 42,
  ...
  buildPlayer({
    ...
    description:
      "Age: 35 | Hometown: Honalulu, Hawaii | Occupation: Project Manager",
    age: 35,
  ...
  buildPlayer({
    ...
    description:
      "Age: 31 | Hometown: Salt Lake City, Utah | Occupation: Clinical Psychologist",
    age: 31,
  ...
  buildPlayer({
    ...
    description:
      "Age: 21 | Hometown: Collierville, Tennasse | Occupation: Graduate Student",
    age: 21,
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: San Francisco, California | Occupation: UX Designer",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 36 | Hometown: Philadelphia, Pennsylvania | Occupation: Event Planner",
    age: 36,
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: El Paso, Texas | Occupation: Warehouse Associate",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 25 | Hometown: Manchester, New Hampshire | Occupation: U.S. Paralympian",
    age: 25,
    profession: "U.S. Paralympian",
  ...
  buildPlayer({
    ...
    description:
      "Age: 19 | Hometown: Las Vegas, Nevada | Occupation: Pet Cremator",
    age: 19,
    profession: "Pet Cremator",
  ...
  buildPlayer({
    ...
    description:
      "Age: 35 | Hometown: Honalulu, Hawaii | Occupation: Elevator Sales",
    age: 35,
    profession: "Elevator Sales",
    hometown: "Honalulu, Hawaii",
  }),
  buildPlayer({
    castaway_id: "US0636",
    ...
    description:
      "Age: 28 | Hometown: Dewark, Delaware | Occupation: Educational Project Manager",
    age: 28,
    profession: "Educational Project Manager",
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Durham, North Carolina | Occupation: Political Science Ph.D.",
    age: 30,
    profession: "Political Science Ph.D.",
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: New Orleans, Louisiana | Occupation: College Admissions Director",
    age: 29,
    profession: "College Admissions Director",
  ...
  buildPlayer({
    ...
    description: "Age: 26 | Hometown: Austin, Texas | Occupation: Designer",
    age: 26,
    profession: "Designer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 51 | Hometown: Meridian, Idaho | Occupation: Heart Valve Specialist",
    age: 51,
    profession: "Heart Valve Specialist",
