...
export const SEASON_5_PLAYERS = [
  buildPlayer({
    ...
    description: "Age: 40 | Hometown: Slidell, Louisiana | Occupation: Pastor",
    age: 40,
    profession: "Pastor",
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Gray, Tennessee | Occupation: Social Worker",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 25 | Hometown: Dallas, Texas | Occupation: Dental Student",
    age: 25,
  ...
  buildPlayer({
    ...
    description:
      "Age: 33 | Hometown: Denver, Colorado | Occupation: Legal Secretary",
    age: 33,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Ozark, Arkansas | Occupation: Firefighter",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Austin, Texas | Occupation: Real Estate Agent",
    age: 26,
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Brooklyn, New York | Occupation: Police Officer",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Plano, Texas | Occupation: Pharmaceutical Sales",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 60 | Hometown: McKinney, Texas | Occupation: Land Broker",
    age: 60,
  ...
  buildPlayer({
    ...
    description:
      "Age: 37 | Hometown: Durham, North Carolina | Occupation: Software Development Manager",
    age: 37,
  ...
  buildPlayer({
    ...
    description:
      "Age: 47 | Hometown: Middletown, Rhode Island | Occupation: Navy Swim Instructor",
    age: 47,
    profession: "Navy Swim Instructor",
  ...
  buildPlayer({
    ...
    description: "Age: 53 | Hometown: Tampa, Florida | Occupation: Teacher",
    age: 53,
    profession: "Teacher",
  ...
  buildPlayer({
    ...
    description:
      "Age: 46 | Hometown: Monroe, Louisiana | Occupation: Restaurant Owner",
    age: 46,
  ...
  buildPlayer({
    ...
    description:
      "Age: 34 | Hometown: Quartz Hill, California | Occupation: Used Car Salesman",
    age: 34,
