...
export const SEASON_2_CASTAWAY_LOOKUP: CastawayLookup = {
  ...
  US0019: { full_name: "Maralyn Hershey", castaway: "Mad Dog" },
...
export const SEASON_2_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 45 | Hometown: Milan, New Hampshire | Occupation: Corrections Officer",
    age: 45,
  ...
  buildPlayer({
    ...
    description:
      "Age: 32 | Hometown: Fort Hood, Texas | Occupation: Army Intelligence Officer",
    age: 32,
    profession: "Army Intelligence Officer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 51 | Hometown: Wakefield, Virginia | Occupation: Retired Police Inspector",
    age: 51,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Union City, New Jersey | Occupation: Singer/Songwriter",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Ronkonkoma, New York | Occupation: Bartender",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 38 | Hometown: White Lake, Michigan | Occupation: Software Publisher",
    age: 38,
  ...
  buildPlayer({
    ...
    description:
      "Age: 34 | Hometown: Manhattan, New York | Occupation: Internet Projects Manager",
    age: 34,
  ...
  buildPlayer({
    ...
    description:
      "Age: 32 | Hometown: Manhattan, New York | Occupation: Personal Trainer",
    age: 32,
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Los Angeles, California | Occupation: Aspiring Actress",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Steilacoom, Washington | Occupation: Harvard Law Student",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 22 | Hometown: Beaver, Pennsylvania | Occupation: Administrative Assistant",
    age: 22,
  ...
  buildPlayer({
    ...
    description:
      "Age: 53 | Hometown: Crittenden, Kentucky | Occupation: Teacher/Farmer",
    age: 53,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Newton, Massachusetts | Occupation: Footwear Designer",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 40 | Hometown: West Bloomfield, Michigan | Occupation: Chef and Restaurateur",
    age: 40,
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Dallas, Texas | Occupation: Auto Customizer",
    age: 26,
  ...
  buildPlayer({
    ...
    description:
      "Age: 40 | Hometown: Knoxville, Tennessee | Occupation: Personal Nurse",
    age: 40,
