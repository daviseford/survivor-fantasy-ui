...
export const SEASON_26_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 38 | Hometown: Brooklyn, New York | Occupation: Attorney",
    age: 38,
    profession: "Attorney",
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Jefferson City, Missouri | Occupation: Pre-Law Student",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Brooklyn, New York | Occupation: Iraq War Veteran",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Washington, D.C. | Occupation: Administrative Officer",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 20 | Hometown: Katy, Texas | Occupation: Oil Tanker Crewman",
    age: 20,
  ...
  buildPlayer({
    ...
    description:
      "Age: 38 | Hometown: Cincinnati, Ohio | Occupation: BMX Bike Sales",
    age: 38,
    profession: "BMX Bike Sales",
  ...
  buildPlayer({
    ...
    description:
      "Age: 21 | Hometown: Stanford, California | Occupation: Racecar Driver",
    age: 21,
  ...
  buildPlayer({
    ...
    description:
      "Age: 33 | Hometown: Los Angeles, California | Occupation: Sales Representative",
    age: 33,
  ...
  buildPlayer({
    ...
    description:
      "Age: 44 | Hometown: New York City, New York | Occupation: Event Planner",
    age: 44,
  ...
  buildPlayer({
    ...
    description:
      "Age: 54 | Hometown: Santa Monica, California | Occupation: Former Federal Agent",
    age: 54,
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: San Francisco, California | Occupation: Real Estate Sales",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: New York City, New York | Occupation: Student",
    age: 23,
    profession: "Student",
    hometown: "New York City, New York",
  }),
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Miami, Florida | Occupation: Paddleboard Company Owner",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Santa Clarita, California | Occupation: Ice Cream Scooper",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 41 | Hometown: Boise, Idaho | Occupation: Fast Food Franchisee",
    age: 41,
    profession: "Fast Food Franchisee",
  ...
  buildPlayer({
    ...
    description:
      "Age: 42 | Hometown: South Jordan, Utah | Occupation: English Professor",
    age: 42,
  ...
  buildPlayer({
    ...
    description:
      "Age: 25 | Hometown: Washington, D.C. | Occupation: Harvard Law Student",
    age: 25,
