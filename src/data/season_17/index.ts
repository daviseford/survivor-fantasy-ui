...
export const SEASON_17_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Los Angeles, California | Occupation: Music Producer",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 61 | Hometown: Temecula, California | Occupation: Retired Nurse",
    age: 61,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Downey, California | Occupation: Waitress",
    age: 23,
    profession: "Waitress",
  ...
  buildPlayer({
    ...
    description:
      "Age: 25 | Hometown: Santa Barbara, California | Occupation: Medical Sales",
    age: 25,
  ...
  buildPlayer({
    ...
    description:
      "Age: 25 | Hometown: Portland, Oregon | Occupation: Maintenance Man",
    age: 25,
    profession: "Maintenance Man",
  ...
  buildPlayer({
    ...
    description:
      "Age: 22 | Hometown: Buffalo Grove, Illinois | Occupation: Student",
    age: 22,
    profession: "Student",
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Naples, Florida | Occupation: Jewelry Sales and Photographer",
    age: 27,
    profession: "Jewelry Sales and Photographer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 32 | Hometown: Boston, Massachusetts | Occupation: Lawyer",
    age: 32,
    profession: "Lawyer",
  ...
  buildPlayer({
    ...
    description: "Age: 28 | Hometown: Atlanta, Georgia | Occupation: Doctor",
    age: 28,
    profession: "Doctor",
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: New York City, New York | Occupation: Lawyer",
    age: 29,
    profession: "Lawyer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 49 | Hometown: Eagle Rock, Missouri | Occupation: Wedding Videographer",
    age: 49,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Los Angeles, California | Occupation: Sales Representative",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Durham, North Carolina | Occupation: Former Olympic Athlete",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 22 | Hometown: Westminster, California | Occupation: Professional Gamer",
    age: 22,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Pacific Palisades, California | Occupation: Personal Trainer",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Brooklyn, New York | Occupation: Pin-Up Model",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 47 | Hometown: Charles City, Iowa | Occupation: Hairdresser",
    age: 47,
