...
export const SEASON_39_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 36 | Hometown: Henderson, Nevada | Occupation: Professional Poker Player",
    age: 36,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Durham, North Carolina | Occupation: Law Student",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Palo Alto, California | Occupation: Admissions Counselor",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Los Angeles, California | Occupation: Digital Content Creator",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 60 | Hometown: Greenwich, Connecticut | Occupation: Former NHL Player",
    age: 60,
  ...
  buildPlayer({
    ...
    img: "",
    description:
      "Age: 32 | Hometown: New York City, New York | Occupation: Personal Injury Lawyer",
    age: 32,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Harrisonburg, Virginia | Occupation: Graduate Student",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Philadelphia, Pennsylvania | Occupation: MBA Student",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 33 | Hometown: Providence, Rhode Island | Occupation: College Administrator",
    age: 33,
  ...
  buildPlayer({
    ...
    description:
      "Age: 36 | Hometown: Warwick, Rhode Island | Occupation: Gym Owner",
    age: 36,
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Tacoma, Washington | Occupation: Air Force Veteran",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Saunderstown, Rhode Island | Occupation: Olympic Medalist",
    age: 26,
  ...
  buildPlayer({
    ...
    description:
      "Age: 37 | Hometown: Houston, Texas | Occupation: Personal Injury Lawyer",
    age: 37,
    profession: "Personal Injury Lawyer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 41 | Hometown: Rockholds, Kentucky | Occupation: Factory Worker",
    age: 41,
  ...
  buildPlayer({
    ...
    description:
      "Age: 48 | Hometown: Los Angeles, California | Occupation: Talent Manager",
    age: 48,
  ...
  buildPlayer({
    ...
    description:
      "Age: 59 | Hometown: Palm Bay, Florida | Occupation: Chief Lifeguard",
    age: 59,
    profession: "Chief Lifeguard",
  ...
  buildPlayer({
    ...
    description: "Age: 28 | Hometown: Glendale, California | Occupation: Nanny",
    age: 28,
    profession: "Nanny",
  ...
  buildPlayer({
    ...
    description:
      "Age: 36 | Hometown: North Potomac, Maryland | Occupation: Entrepreneur",
    age: 36,
  ...
  buildPlayer({
    ...
    description:
      "Age: 28 | Hometown: New York City, New York | Occupation: Tech Sales",
    age: 28,
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Long Beach, New York | Occupation: 4th Grade Teacher",
    age: 26,
