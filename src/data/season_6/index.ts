...
export const SEASON_6_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Ellicott City, Maryland | Occupation: Model",
    age: 23,
    profession: "Model",
  ...
  buildPlayer({
    ...
    description:
      "Age: 46 | Hometown: Manchester, Missouri | Occupation: Homemaker",
    age: 46,
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Houston, Texas | Occupation: Tax Accountant",
    age: 26,
  ...
  buildPlayer({
    ...
    description:
      "Age: 31 | Hometown: Orangeburg, South Carolina | Occupation: Guidance Counselor",
    age: 31,
  ...
  buildPlayer({
    ...
    description:
      "Age: 40 | Hometown: North Attleboro, Massachusetts | Occupation: Marketing Director",
    age: 40,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Los Angeles, California | Occupation: Retail Saleswoman",
    age: 23,
    profession: "Retail Saleswoman",
  ...
  buildPlayer({
    ...
    description:
      "Age: 56 | Hometown: Valencia, California | Occupation: Construction Company V.P.",
    age: 56,
    profession: "Construction Company V.P.",
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Pasadena, California | Occupation: Rocket Scientist",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 35 | Hometown: Riverside, California | Occupation: Deputy District Attorney",
    age: 35,
  ...
  buildPlayer({
    ...
    description:
      "Age: 32 | Hometown: Los Angeles, California | Occupation: Triathlon Coach",
    age: 32,
    profession: "Triathlon Coach",
    hometown: "Los Angeles, California",
    nickname: "Alex",
  }),
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Basalt, Colorado | Occupation: Children's Adventure Guide",
    age: 24,
    profession: "Children's Adventure Guide",
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Jefferson City, Missouri | Occupation: Gym Teacher",
    age: 24,
  ...
  buildPlayer({
    ...
    description: "Age: 50 | Hometown: Olney, Illinois | Occupation: Principal",
    age: 50,
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Wantagh, New York | Occupation: Computer Projects Coordinator",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 33 | Hometown: Washington, D.C. | Occupation: Restaurant Designer",
    age: 33,
    profession: "Restaurant Designer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 21 | Hometown: Bridgeville, Pennsylvania | Occupation: Swimsuit Model",
    age: 21,
