...
export const SEASON_1_PLAYERS = [
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: San Francisco, California | Occupation: Attorney",
    age: 27,
    profession: "Attorney",
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Edison, New Jersey | Occupation: Biochemist",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Spring Green, Wisconsin | Occupation: Dairy Farmer",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Sherwood, Arkansas | Occupation: Health Club Consultant",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 38 | Hometown: Clarksville, Tennessee | Occupation: Teacher",
    age: 38,
    profession: "Teacher",
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Gold Hill, Colorado | Occupation: Ivy League Graduate",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 22 | Hometown: Franklin, New Hampshire | Occupation: Student",
    age: 22,
    profession: "Student",
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Willingboro, New Jersey | Occupation: YMCA Basketball Coach",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Miami Beach, Florida | Occupation: Student",
    age: 23,
    profession: "Student",
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Carle Place, New York | Occupation: Doctor",
    age: 30,
    profession: "Doctor",
  ...
  buildPlayer({
    ...
    description:
      "Age: 38 | Hometown: Palmyra, Wisconsin | Occupation: Truck Driver",
    age: 38,
  ...
  buildPlayer({
    ...
    description:
      "Age: 22 | Hometown: Kernville, California | Occupation: River Guide",
    age: 22,
  ...
  buildPlayer({
    ...
    description:
      "Age: 39 | Hometown: Newport, Rhode Island | Occupation: Corporate Trainer",
    age: 39,
