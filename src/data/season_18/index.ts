...
export const SEASON_18_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: West Hollywood, California | Occupation: Bartender",
    age: 26,
  ...
  buildPlayer({
    ...
    description:
      "Age: 31 | Hometown: Los Angeles, California | Occupation: Attorney",
    age: 31,
    profession: "Attorney",
  ...
  buildPlayer({
    ...
    description:
      "Age: 49 | Hometown: Rock Hill, South Carolina | Occupation: Sgt - U.S. Army",
    age: 49,
    profession: "Sgt - U.S. Army",
  ...
  buildPlayer({
    ...
    description:
      "Age: 53 | Hometown: Louisville, Kentucky | Occupation: Bus Driver",
    age: 53,
  ...
  buildPlayer({
    ...
    description:
      "Age: 19 | Hometown: Gainesville, Florida | Occupation: Student",
    age: 19,
    profession: "Student",
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: San Diego, California | Occupation: Model",
    age: 24,
    profession: "Model",
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Austin, Texas | Occupation: Real Estate Sales",
    age: 26,
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Vail, Colorado | Occupation: Entrepreneur",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Heber City, Utah | Occupation: Former Professional Cyclist/Missionary",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Los Angeles, California | Occupation: Model",
    age: 23,
    profession: "Model",
    hometown: "Los Angeles, California",
  }),
  ...
  buildPlayer({
    ...
    description:
      "Age: 37 | Hometown: Bolivar, Missouri | Occupation: Soccer Coach",
    age: 37,
  ...
  buildPlayer({
    ...
    description:
      "Age: 37 | Hometown: Nashville, Tennessee | Occupation: Former Pop Star",
    age: 37,
    profession: "Former Pop Star",
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Milwaukee, Wisconsin | Occupation: Hairstylist",
    age: 26,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: New York City, New York | Occupation: Corporate Consultant",
    age: 29,
