...
export const SEASON_45_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 33 | Hometown: Baltimore City, Maryland | Occupation: Therapist",
    age: 33,
  ...
  buildPlayer({
    ...
    description:
      "Age: 25 | Hometown: Sicklerville, New Jersey | Occupation: Content Producer",
    age: 25,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Jacksonville, North Carolina | Occupation: Truck Driver",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 34 | Hometown: Provo-Orem, Utah | Occupation: School Principal",
    age: 34,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Seattle, Washington | Occupation: Software Developer",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Los Angeles, California | Occupation: Singer",
    age: 24,
    profession: "Singer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: O'Fallon, Illinois | Occupation: Gym Owner",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Vancouver, British Columbia | Occupation: Software Sales",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: New York, New York | Occupation: Critical Care Nurse",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Steamboat Springs, Colorado | Occupation: Bartender",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 46 | Hometown: Warwick, Rhode Island | Occupation: Insurance Agent",
    age: 46,
  ...
  buildPlayer({
    ...
    description:
      "Age: 28 | Hometown: Laurel, Maryland | Occupation: Investment Analyst",
    age: 28,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Philadelphia, Pensylvania | Occupation: Graduate Student",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 49 | Hometown: Brentwood, Tennessee | Occupation: Estate Attorney",
    age: 49,
  ...
  buildPlayer({
    ...
    description:
      "Age: 34 | Hometown: Brooklyn, New York | Occupation: Civil Rights Attorney",
    age: 34,
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Boston, Massachusetts | Occupation: Attorney",
    age: 26,
    profession: "Attorney",
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Chicago, Illinois | Occupation: Graduate Student",
    age: 26,
    profession: "Graduate Student",
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Miami, Florida | Occupation: Entrepreneur",
    age: 26,
