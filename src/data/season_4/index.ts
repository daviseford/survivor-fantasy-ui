...
export const SEASON_4_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 44 | Hometown: Millis, Massachusetts | Occupation: Bowling Alley Owner",
    age: 44,
    profession: "Bowling Alley Owner",
  ...
  buildPlayer({
    ...
    description:
      "Age: 49 | Hometown: Lugoff, South Carolina | Occupation: Truck Assembler",
    age: 49,
    profession: "Truck Assembler",
  ...
  buildPlayer({
    ...
    description:
      "Age: 33 | Hometown: La Jolla, California | Occupation: Former Navy Fighter Pilot",
    age: 33,
    profession: "Former Navy Fighter Pilot",
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Newport Beach, California | Occupation: Account Manager",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Hollywood, California | Occupation: Bartender",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 28 | Hometown: Gainesville, Florida | Occupation: Nature Guide",
    age: 28,
    profession: "Nature Guide",
  ...
  buildPlayer({
    ...
    description:
      "Age: 25 | Hometown: Canton, Massachusetts | Occupation: Construction Worker",
    age: 25,
  ...
  buildPlayer({
    ...
    description:
      "Age: 36 | Hometown: Omaha, Nebraska | Occupation: Registered Nurse",
    age: 36,
  ...
  buildPlayer({
    ...
    description:
      "Age: 35 | Hometown: Monhegan, Maine | Occupation: Fishing Boat Captain",
    age: 35,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Mesa, Arizona | Occupation: Crime Reporter",
    age: 29,
    profession: "Crime Reporter",
  ...
  buildPlayer({
    ...
    description:
      "Age: 38 | Hometown: College Point, New York | Occupation: Limousine Driver",
    age: 38,
    profession: "Limousine Driver",
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Los Angeles, California | Occupation: Teacher",
    age: 30,
    profession: "Teacher",
  ...
  buildPlayer({
    ...
    description: "Age: 56 | Hometown: Thomaston, Georgia | Occupation: Judge",
    age: 56,
    profession: "Judge",
  ...
  buildPlayer({
    ...
    img: "",
    description:
      "Age: 46 | Hometown: Burlington, Vermont | Occupation: Real Estate Agent",
    age: 46,
  ...
  buildPlayer({
    ...
    description: "Age: 21 | Hometown: Layton, Utah | Occupation: Student",
    age: 21,
    profession: "Student",
  ...
  buildPlayer({
    ...
    description:
      "Age: 36 | Hometown: Hayward, California | Occupation: Office Manager",
    age: 36,
