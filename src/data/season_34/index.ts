...
export const SEASON_34_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Salem, Oregon | Occupation: Cosmetology Student",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 42 | Hometown: Jersey City, New Jersey | Occupation: Police Officer",
    age: 42,
  ...
  buildPlayer({
    ...
    description:
      "Age: 28 | Hometown: Hopkinsville, Kentucky | Occupation: Army Veteran",
    age: 28,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Hermosa Beach, California | Occupation: Bartender",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 41 | Hometown: Fayetteville, North Carolina | Occupation: Office Assistant",
    age: 41,
  ...
  buildPlayer({
    ...
    description:
      "Age: 50 | Hometown: High Point, North Carolina | Occupation: Internet Projects Manager",
    age: 50,
  ...
  buildPlayer({
    ...
    description:
      "Age: 26 | Hometown: Knoxville, Tennessee | Occupation: Law Student",
    age: 26,
  ...
  buildPlayer({
    ...
    description: "Age: 34 | Hometown: Venice, California | Occupation: Waiter",
    age: 34,
    profession: "Waiter",
  ...
  buildPlayer({
    ...
    description:
      "Age: 51 | Hometown: Reading, Pennsylvania | Occupation: Chemist",
    age: 51,
    profession: "Chemist",
  ...
  buildPlayer({
    ...
    description: "Age: 29 | Hometown: Roy, Utah | Occupation: Barrel Racer",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: New York City, New York | Occupation: Student",
    age: 27,
    profession: "Student",
  ...
  buildPlayer({
    ...
    description: "Age: 45 | Hometown: Norwalk, Connecticut | Occupation: Nurse",
    age: 45,
    profession: "Nurse",
  ...
  buildPlayer({
    ...
    description:
      "Age: 30 | Hometown: Cambridge, Massachusetts | Occupation: Social Media Marketer",
    age: 30,
  ...
  buildPlayer({
    ...
    description:
      "Age: 52 | Hometown: San Francisco, California | Occupation: Gardener",
    age: 52,
    profession: "Gardener",
  ...
  buildPlayer({
    ...
    description:
      "Age: 54 | Hometown: Miami, Florida | Occupation: Swimsuit Photographer",
    age: 54,
    profession: "Swimsuit Photographer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 47 | Hometown: Tampa, Florida | Occupation: Attorney/Retired NFL Player",
    age: 47,
  ...
  buildPlayer({
    ...
    description:
      "Age: 32 | Hometown: Marion, Iowa | Occupation: Police Officer",
    age: 32,
    profession: "Police Officer",
