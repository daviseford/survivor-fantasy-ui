...
export const SEASON_10_PLAYERS = [
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Dallas, Texas | Occupation: Sales & Marketing Associate",
    age: 23,
    profession: "Sales & Marketing Associate",
  ...
  buildPlayer({
    ...
    description:
      "Age: 55 | Hometown: Ulysses, Pennsylvania | Occupation: English Teacher",
    age: 55,
  ...
  buildPlayer({
    ...
    description: "Age: 38 | Hometown: Houston, Texas | Occupation: Lawyer",
    age: 38,
    profession: "Lawyer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 22 | Hometown: Easley, South Carolina | Occupation: Student",
    age: 22,
    profession: "Student",
  ...
  buildPlayer({
    ...
    description:
      "Age: 21 | Hometown: Ventura, California | Occupation: Personal Trainer",
    age: 21,
  ...
  buildPlayer({
    ...
    description:
      "Age: 56 | Hometown: Bellevue, Washington | Occupation: Lawyer",
    age: 56,
    profession: "Lawyer",
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: New Orleans, Louisiana | Occupation: Bartender",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 33 | Hometown: Mobile, Alabama | Occupation: Steelworker",
    age: 33,
  ...
  buildPlayer({
    ...
    description: "Age: 27 | Hometown: Birmingham, Alabama | Occupation: Waiter",
    age: 27,
    profession: "Waiter",
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Los Angeles, California | Occupation: Waiter",
    age: 27,
    profession: "Waiter",
  ...
  buildPlayer({
    ...
    description: "Age: 32 | Hometown: Athens, Texas | Occupation: Hairstylist",
    age: 32,
  ...
  buildPlayer({
    ...
    description:
      "Age: 39 | Hometown: Las Vegas, Nevada | Occupation: Vegas Showgirl",
    age: 39,
    profession: "Vegas Showgirl",
  ...
  buildPlayer({
    ...
    description:
      "Age: 24 | Hometown: Toms River, New Jersey | Occupation: Pharmaceutical Sales Representative",
    age: 24,
  ...
  buildPlayer({
    ...
    description:
      "Age: 27 | Hometown: Chicago, Illinois | Occupation: Business Consultant",
    age: 27,
  ...
  buildPlayer({
    ...
    description:
      "Age: 46 | Hometown: Solon, Ohio | Occupation: Civil Rights Lawyer",
    age: 46,
  ...
  buildPlayer({
    ...
    description: "Age: 32 | Hometown: Encino, California | Occupation: Nanny",
    age: 32,
    profession: "Nanny",
  ...
  buildPlayer({
    ...
    description:
      "Age: 23 | Hometown: Ambridge, Pennsylvania | Occupation: Dolphin Trainer",
    age: 23,
  ...
  buildPlayer({
    ...
    description:
      "Age: 29 | Hometown: Merced, California | Occupation: Advertising Executive",
    age: 29,
  ...
  buildPlayer({
    ...
    description:
      "Age: 40 | Hometown: Sayville, New York | Occupation: Firefighter",
    age: 40,
